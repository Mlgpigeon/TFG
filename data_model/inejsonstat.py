...
from data_model.jsondataset import ProcJsonStatDataset
from data_model.ine_status import Status
from data_model.jsonstatcategory import JsonStatCategory
from data_model.jsonstatdimension import JsonStatDimension
from data_model.jsonutil import JsonUtil as util
from data_model.main_logger import logger
import data_model.enumerator_hub as hub
from data_model.dimensionEnum import DimensionEnum
from data_model.enumerator_hub import EnumeratorHub
...
class IneJsonStat:
    ...
    def generate_object(self):
        ...
        flag_json_read, json_data = util.read_json_file(self.url)
    ...
    def get_number_dimensions(self):
        ...
        while not exit_flag:
            try:
                ...
                exception_message = 'IneJsonStat || Module [get_number_dimensions], limit position: ' + str(i) + ", " + str(e)
    ...
    def calculate_category_size(dimension):
        ...
        while not exit_flag:
            try:
                ...
                exception_message = 'IneJsonStat || Module [calculate_category_size], limit position: ' + str(i) + ", " + str(e)
                logger.debug(exception_message)
                exit_flag = True
        return i
    ...
    def generate_enumerators(self):
        ...
        for a in self.dimensions_names:
            ...
            for value in values:
                ...
                tuplenamed = DimensionItem(adapted_name, value, table2.columns.values, table2, valuetable, statustable, data_list, value_list, status_list)
